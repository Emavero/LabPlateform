package com.labplatform.adapter.out.process;

import java.time.Duration;
import java.util.List;

/** Exécute une commande système. Abstrait pour pouvoir tester les adaptateurs (Docker, easy-rsa) sans les outils réels. */
